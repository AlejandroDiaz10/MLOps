...
from fase3.plots import plot_confusion_matrix, plot_roc_curve, plot_feature_importance
...
def evaluate_model(
    ...
    if not model_path.exists():
        raise FileNotFoundError(
            ...
            "Run 'python -m fase3.modeling.train' first."
        )
    ...
    if not X_test_path.exists() or not y_test_path.exists():
        raise FileNotFoundError(
            "Test data not found. Run 'python -m fase3.features' first."
        )
...
def main():
    ...
    def predict(
        ...
        Example:
            python -m fase3.modeling.predict
            python -m fase3.modeling.predict --model-path models/logistic_regression_pipeline.pkl
            python -m fase3.modeling.predict --no-plots
        """
