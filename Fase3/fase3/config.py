...
class MLflowConfig(BaseModel):
    ...
    tracking_uri: str = Field(
        default="http://34.67.152.248:5000", description="MLflow tracking server URI"
    )
    experiment_name: str = Field(
        default="equipo34-german-credit", description="MLflow experiment name"
    )
    artifact_location: Optional[str] = Field(
        default="s3://itesm-mna/202502-equipo34/mlflow-artifacts",
        description="S3 location for MLflow artifacts",
    )
...
class DVCConfig(BaseModel):
    ...
    remote_name: str = Field(default="team_remote")
    remote_url: str = Field(default="s3://itesm-mna/202502-equipo34")
...
class APIConfig(BaseModel):
    ...
    model_name: str = Field(default="german_credit_classifier")
