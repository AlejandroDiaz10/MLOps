...
from fase3.dataset import main as run_data_cleaning
from fase3.features import main as run_feature_engineering
from fase3.modeling.train import train_model
from fase3.modeling.predict import evaluate_model
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1 or sys.argv[1].startswith("--"):
        # Insert 'run' as the first command
